...
void SensorFusion::Step1() {
  vaf::OutputSyncStream{} << "Step1 is performed: Clapton likes to clap" << std::endl;
}

void SensorFusion::Step2() {
  vaf::OutputSyncStream{} << "Step2 is performed: Mayo is naise" << std::endl;
}

void SensorFusion::Step2a() {
  vaf::OutputSyncStream{} << "Step2a is performed: Penultimate is not Penaldo" << std::endl;
  _status = true;
}

void SensorFusion::Step2b() {
  vaf::OutputSyncStream{} << "Step2b is performed -> Done!" << std::endl;
  nada = "Pico-Bello";
}
