...
=======
  ...
  void TestHelper(vaf::String& mock_str, bool mock_status);
  virtual void Step2() = 0;
  virtual void Step3() = 0;
  int GetTestNumber(vaf::String& test_name);
