...
brake_pressure.add_subelement(name="brake_pressure", datatype=BaseTypes.UINT8_T)
...
# ImageService
uint8_vector_307200 = vafpy.datatypes.Vector(name="UInt8Vector", namespace="datatypes", datatype=BaseTypes.UINT8_T)
...
steering_angle.add_subelement(name="steering_angle", datatype=BaseTypes.UINT16_T)
